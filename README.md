...
A cross-platform auto splitter for Halo: MCC using LiveSplit ASR.

Adapted from the [original ASL auto splitter by Burnt/Cambid](https://github.com/Burnt-o/MCC_autosplitter)
...
```
target/wasm32-unknown-unknown/release/mcc_splitter_asr.wasm
```
